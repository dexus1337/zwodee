...
namespace zwodee
{
    ...
    void textured_object::render(renderer& target_renderer, double alpha)
    {
        ...
        target_renderer.draw_sprite(*m_texture, 0, 0, m_texture->get_width(), m_texture->get_height(), render_x, render_y, m_width, m_height);
    }
    ...
    render_node textured_object::get_render_node() const
    {
        ...
        return render_node{ m_x, m_y, m_width, m_height, m_texture, 0, 0, m_texture->get_width(), m_texture->get_height() };
    }
